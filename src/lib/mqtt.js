...
//******COMMENTED FOR NOW TO PROCEED WITH THE DEVELOPMENT LATER******
...
//
//
//         const PahoMQTT = (function (global) {
//
//             // Private variables below, these are only visible inside the function closure
//             // which is used to define the module.
//             const version = '@VERSION@-@BUILDLEVEL@';
//
//             /**
//              * @private
//              */
//             const localStorage = global.localStorage || (function () {
//                 const data = {};
//
//                 return {
...
//              * @ignore
//              */
//             const Pinger = function (client, keepAliveInterval) {
//                 this._client = client;
...
//                 for (const key in localStorage) if (key.indexOf(`Sent:${this._localKey}`) === 0 || key.indexOf(`Received:${this._localKey}`) === 0) this.restore(key);
//             };
//
...
//                     wireMessage.onSuccess = function (grantedQos) { subscribeOptions.onSuccess({ invocationContext: subscribeOptions.invocationContext, grantedQos }); };
//                 }
//
//                 if (subscribeOptions.onFailure) {
//                     wireMessage.onFailure = function (errorCode) { subscribeOptions.onFailure({ invocationContext: subscribeOptions.invocationContext, errorCode, errorMessage: format(errorCode) }); };
//                 }
//
...
//                             var sequencedMessages = sequencedMessages.sort((a, b) => a.sequence - b.sequence);
...
//                     if (this._reconnectInterval < 128) this._reconnectInterval *= 2;
...
//                     host: {
//                         get() { return host; },
//                         set() { throw new Error(format(ERROR.UNSUPPORTED_OPERATION)); }
//                     },
//                     port: {
//                         get() { return port; },
//                         set() { throw new Error(format(ERROR.UNSUPPORTED_OPERATION)); }
...
//                             else throw new Error(format(ERROR.INVALID_TYPE, [typeof newOnConnected, 'onConnected']));
//                         }
//                     },
//                     disconnectedPublishing: {
//                         get() { return client.disconnectedPublishing; },
//                         set(newDisconnectedPublishing) {
//                             client.disconnectedPublishing = newDisconnectedPublishing;
//                         }
//                     },
//                     disconnectedBufferSize: {
//                         get() { return client.disconnectedBufferSize; },
//                         set(newDisconnectedBufferSize) {
//                             client.disconnectedBufferSize = newDisconnectedBufferSize;
//                         }
//                     },
//                     onConnectionLost: {
//                         get() { return client.onConnectionLost; },
...
//                     },
//                     onMessageDelivered: {
//                         get() { return client.onMessageDelivered; },
...
//                     },
//                     onMessageArrived: {
//                         get() { return client.onMessageArrived; },
...
//                     },
//                     trace: {
//                         get() { return client.traceFunction; },
//                         set(trace) {
...
//                         enumerable: true,
//                         get() { return destinationName; },
//                         set(newTopic) { destinationName=newTopic; }
//                     },
//                     duplicate: {
//                         enumerable: true,
//                         get() { return duplicate; },
//                         set(newDuplicate) { duplicate=newDuplicate; }
//                     }
//                 });
//             };
//
